...
```sh
# Using npm
npm install --global tester-init

# Using yarn
yarn global add tester-init
```
...
Here is an example how to use this package as library. To install it locally, as library, you can use `npm install tester-init` (or `yarn add tester-init`):
